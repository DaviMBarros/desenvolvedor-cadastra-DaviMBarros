    ...
    return (
        <div className={style.modal} role="dialog">
            ...
            <div className={style.divbuttons}>
                <button onClick={()=> {closeModal(); sortOrder("Mais recente")}}>Mais recente</button>
                <button onClick={()=> {closeModal(); sortOrder("Maior preço")}}>Maior preço</button>
                <button onClick={()=> {closeModal(); sortOrder("Menor preço")}}>Menor preço</button>
            </div>
        </div>
    )
}
